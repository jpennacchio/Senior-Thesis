...
from MultistepResidualBootstrap_NoSelection import union, Residual_Bootstrap_2SLS_NoSelection 
...
def GDP():
    ...
    z_array = np.array(z)
    print('GDP')
    res0 = Residual_Bootstrap_2SLS_NoSelection(x_array, y_array, d_array, z_array, method = 1)
    print(res0)
def FHFA():
    data= data_prep_FHFA()
    x, y, d, z = data[0], data[1], data[2], data[3]
    ...
    print('FHFA')
    res10 = Residual_Bootstrap_2SLS_NoSelection(x_array, y_array, d_array, z_array, method = 1)
    print(res10)
def NonMetro():
    ...
    print('NonMetro')
    res20 = Residual_Bootstrap_2SLS_NoSelection(x_array, y_array, d_array, z_array, method = 1)
    print(res20)
...
def CS():
    ...
    print('CS')
    res30 = Residual_Bootstrap_2SLS_NoSelection(x_array, y_array, d_array, z_array, method = 1)
    print(res30)
